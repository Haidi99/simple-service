 ...
 * 
 */
@WebServiceClient(name = "EmpServiceImplService", targetNamespace = "AnyThing", wsdlLocation = "http://localhost:7070/emp?wsdl")
    ...
    extends Service
{
    ...
    private final static QName EMPSERVICEIMPLSERVICE_QNAME = new QName("AnyThing", "EmpServiceImplService");

    static {
        URL url = null;
        WebServiceException e = null;
        try {
            url = new URL("http://localhost:7070/emp?wsdl");
     ...
     * 
     * @return
     *     returns EmpServiceImpl
     */
    @WebEndpoint(name = "EmpServiceImplPort")
    public EmpServiceImpl getEmpServiceImplPort() {
        return super.getPort(new QName("AnyThing", "EmpServiceImplPort"), EmpServiceImpl.class);
    }
     ...
     */
    @WebEndpoint(name = "EmpServiceImplPort")
    public EmpServiceImpl getEmpServiceImplPort(WebServiceFeature... features) {
        return super.getPort(new QName("AnyThing", "EmpServiceImplPort"), EmpServiceImpl.class, features);
    }
