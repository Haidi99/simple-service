 ...
 *       &lt;sequence>
 *         &lt;element name="return" type="{AnyThing}empRepo" maxOccurs="unbounded" minOccurs="0"/>
 *       &lt;/sequence>
 *     &lt;/restriction>
 *   &lt;/complexContent>
 * &lt;/complexType>
...
public class GetAllPersonsResponse {
    ...
    protected List<EmpRepo> _return;
     ...
     * 
     */
    public List<EmpRepo> getReturn() {
        if (_return == null) {
            _return = new ArrayList<EmpRepo>();
        }
        return this._return;
    }
